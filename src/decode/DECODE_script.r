...
#' or 
#'
runDecode("C:/project-biomedical network science/decode/extdata/geneSet.txt","C:/project-biomedical network science/decode/extdata/Expression_data_50genes.txt")
#'
...
#'@examples
#'\dontrun{
#path = system.file("C:/project-biomedical network science/decode/extdata", package='decode')
...
runDecode =function(geneSetInputFile, geneExpressionFile) 
  ...
  # gene set data
  geneSetInputFile = "C:/project-biomedical network science/decode/extdata/geneSet.txt"
  # gene expression data
  geneExpressionFile ="C:/project-biomedical network science/decode/extdata/Expression_data_50genes.txt"
  # significant level
...
# Plot the distribution of chi square values
ggplot(temp, aes(x = chi.square.value)) +
  geom_histogram(binwidth = 0.5, fill = "blue", color = "black", alpha = 0.3) +
  labs(title = "Distribution of chi.square.values",
       x = "chi.square.value",
       y = "Frequency") +
  theme_minimal()
