...
def main(input_file_1, input_file_2, output_file,num_rep_cells,threshold) :
    ...
    plot_grn(grn_df_plot,threshold,"GRN_net_macrophage")
    ...
    # Get the current working directory
    current_directory = os.getcwd()
    print("You can find the grn tsv file in the following directory : " + current_directory)
    print("The plots can be found in outs_scan folder in the same directory")
