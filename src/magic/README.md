...
Study: Hsiao, T.-H. et al. Differential network analysis reveals the genome-wide landscape of estrogen receptor modulation in hormonal cancers. Sci. Rep. 6, 23035; doi: 10.1038/srep23035 (2016).
Differential network analysis reveals the genome-wide landscape of estrogen receptor modulation in hormonal cancers - PubMed (nih.gov)
Github:GitHub - chenlabgccri/MAGIC
...
(No date) Index of /. Available at: https://resources.aertslab.org/cistarget/tf_lists/allTFs_hg38.txt (Accessed: 13 May 2024). 
